...
describe('Controllers > Orders', () => {
  ...
  it('should build a list of errors', () => {
    const method = 'create';
    const errorMessage = 'Please provide a list of products';
    const existsFn = jest.fn().mockReturnValueOnce(errorMessage);
    ...
    expect(validator.body).toHaveBeenCalledWith('products', errorMessage);
  });

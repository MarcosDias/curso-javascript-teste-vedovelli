...
describe('Cart', () => {
  ...
  describe('getTotal()', () => {
    ...
    it('should ensure no more than on product exists at the time', () => {
      cart.add({
        product,
        quantity: 2,
      });
  ...
  describe('checkout()', () => {
    it('should return a object with the total and the list of items', () => {
      cart.add({
        product,
        quantity: 2,
      });
  ...
  describe('special conditions', () => {
    ...
    it('should include formatted amount in the summary', () => {
      ...
      expect(cart.summary().formatted).toEqual('R$2,606.84');
    });
  });
});
